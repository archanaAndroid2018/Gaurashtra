...
public class AppPreference {
  ...
  public   void setDisableSavedCards(boolean disableSavedCards) {
   ...
   public void setDisableNetBanking(boolean disableNetBanking) {
        isDisableNetBanking = disableNetBanking;
    }
    public boolean isDisableThirdPartyWallets() {
        return isDisableThirdPartyWallets;
    }

   public void setDisableThirdPartyWallets(boolean disableThirdPartyWallets) {
        isDisableThirdPartyWallets = disableThirdPartyWallets;
    }
   public boolean isDisableExitConfirmation() {
        return isDisableExitConfirmation;
    }

   public void setDisableExitConfirmation(boolean disableExitConfirmation) {
