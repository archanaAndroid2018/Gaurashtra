...
public class PrivacyPolicyFrag extends Fragment {
    public static final String TAG = PrivacyPolicyFrag.class.getSimpleName();
    View view;
    WebView webView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView= view.findViewById(R.id.wv_privacy_policy);
    ...
    private void getPrivacyPolicy() {
        ...
        Call<LeftMenuContentBean> call= restInterface.getPrivacyPolicy(globalUtils.getKey(), globalUtils.getapidate());
        call.enqueue(new Callback<LeftMenuContentBean>() {
            ...
            public void onResponse(Call<LeftMenuContentBean> call, Response<LeftMenuContentBean> response) {
                if(response.isSuccessful()){
                    ...
                    content= response.body().getResult().getPrivacyPolicy().getDescription();
